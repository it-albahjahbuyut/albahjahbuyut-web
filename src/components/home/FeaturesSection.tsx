    ...
    return (
        <section className="relative bg-emerald-950 text-white">
            ...
            <div className="relative py-16 lg:py-24 flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 container mx-auto px-6 md:px-12 lg:px-24 py-10 text-center flex flex-col items-center"> {/* Adjusted padding and alignment */}
                    <FadeIn>
                    ...
                    <FadeIn delay={0.2}>
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold uppercase mb-6 max-w-5xl text-white leading-[1.1] text-center mx-auto">
                    ...
                    <FadeIn delay={0.4}>
                        <p className="text-emerald-100/90 font-serif italic text-lg md:text-xl mb-10 tracking-wide max-w-2xl leading-relaxed text-center mx-auto">
                    ...
                    <FadeIn delay={0.6} className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
                        <Link
                            ...
                            className="group relative px-8 py-4 bg-gold-500 text-emerald-950 font-bold tracking-widest text-xs overflow-hidden rounded-none transition-all hover:bg-white hover:text-emerald-950 hover:shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)]"
                        >
