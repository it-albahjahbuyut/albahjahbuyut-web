            ...
            <div className="container mx-auto px-4 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
                    <div className="max-w-3xl">
                        ...
                        <h2 className="text-4xl lg:text-5xl font-bold text-emerald-950 mb-4 uppercase tracking-tight">Berita Terbaru</h2>
                    ...
                    <Link
                        href="/berita"
                        className="inline-flex items-center justify-center px-6 py-3 bg-white border border-slate-300 text-emerald-950 font-bold hover:bg-emerald-950 hover:text-white hover:border-emerald-950 transition-all uppercase tracking-widest text-xs"
                    >
                        Lihat Semua
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {posts.map((post) => (
                        <article key={post.id} className="group flex flex-col bg-white border-b-2 border-slate-100 hover:border-emerald-600 transition-all duration-300 h-full pb-4">
                            <div className="aspect-video relative overflow-hidden bg-slate-100 mb-6">
                                {post.image ? (
                                    <Image
                                        src={post.image}
                                        alt={post.title}
                            ...
                            <div className="px-2 flex flex-col flex-1">
                                ...
                                <div
                                    className="text-slate-500 text-sm leading-relaxed mb-6 line-clamp-3 font-light"
